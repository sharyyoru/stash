      ...
      <div className="mx-auto max-w-7xl px-4 py-10 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link
            ...
            className="group rounded-2xl bg-gradient-to-br from-green-50 to-green-100 p-6 shadow-sm ring-1 ring-green-200 transition-all hover:shadow-md hover:ring-green-300"
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <svg className="h-5 w-5 text-green-400 group-hover:text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </div>
            <h3 className="font-semibold text-green-900 mb-1">Discount Codes</h3>
            <p className="text-2xl font-bold text-green-900 mb-1">Promos</p>
            <p className="text-xs text-green-700">
              Manage discount codes & reports
            </p>
          </Link>
        </div>
